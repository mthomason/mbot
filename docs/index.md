...
Ready to build your own chatbot? Head over to our [GitHub repository](https://github.com/mthomason/mbot) to clone the project, explore the code, and get started with the setup instructions.
...
![mbot preview animation](assets/images/mbot_preview.gif)
